    ...
    return playerInfo ? (
      <div>
        ...
        <div className="container">
          <CTitle>
            <img
              src={playerInfo.avatarUrl && playerInfo.avatarUrl}
              style={{ width: "250px" }}
              alt="description"
            ></img>
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            >
              ...
              >
                <span>Club </span>
                <span> {playerInfo.club[0].tenDoiBong}</span>{" "}
              </div>
              <hr />
              <div
                style={{
            ...
            >
              ...
              >
                <span>Height </span>
                <span>{playerInfo.chieuCao} cm</span>{" "}
              </div>
              <hr />
              <div
                style={{
              ...
              >
                <span>Weight </span>
                <span>{playerInfo.canNang} kg</span>{" "}
              </div>
              <hr />
            </Card>
          </div>
